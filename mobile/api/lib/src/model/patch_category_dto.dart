...
part 'patch_category_dto.g.dart';
...
@BuiltValue()
abstract class PatchCategoryDto implements Built<PatchCategoryDto, PatchCategoryDtoBuilder> {
  ...
  factory PatchCategoryDto([void updates(PatchCategoryDtoBuilder b)]) = _$PatchCategoryDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(PatchCategoryDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<PatchCategoryDto> get serializer => _$PatchCategoryDtoSerializer();
}

class _$PatchCategoryDtoSerializer implements PrimitiveSerializer<PatchCategoryDto> {
  @override
  final Iterable<Type> types = const [PatchCategoryDto, _$PatchCategoryDto];

  @override
  final String wireName = r'PatchCategoryDto';

  Iterable<Object?> _serializeProperties(
    Serializers serializers,
    PatchCategoryDto object, {
  ...
  void _deserializeProperties(
    ...
    required PatchCategoryDtoBuilder result,
  ...
  @override
  PatchCategoryDto deserialize(
    Serializers serializers,
    Object serialized, {
    FullType specifiedType = FullType.unspecified,
  }) {
    final result = PatchCategoryDtoBuilder();

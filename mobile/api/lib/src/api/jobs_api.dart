...
class JobsApi {
  ...
  Future<Response<void>> triggerOrphanCleanup({ 
    ...
    final _path = r'/jobs/cleanup-orphans';
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> triggerOrphanFileCleanup({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/jobs/cleanup-orphan-files';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
